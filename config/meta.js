...
module.exports = function (config, isSitemap = false) {
  ...
  const meta = {
    ...
    '/about': [
      `About Serverlets AI - Our Story & Mission`,
      `Learn about Serverlets AI's journey from open-source project to the most trusted privacy-focused email service. Discover our commitment to transparency, security, and user privacy.`,
      'img/articles/about.webp'
    ],
    '/press': [
      `Press & Media Kit - Serverlets AI Brand Assets & Resources`,
      `Download Serverlets AI logos, brand guidelines, screenshots, and media assets. Press inquiries welcome. Get official graphics and branding for articles and publications.`,
    ...
    '/tti': [
      ...
      `Real-time email deliverability monitoring and time-to-inbox metrics. Compare Serverlets AI's delivery speed vs Gmail, Outlook, Yahoo, and iCloud. Transparent performance data updated every minute.`,
    ...
    '/terms': [
      `Terms of Service - Serverlets AI User Agreement`,
      `Read Serverlets AI's terms of service, acceptable use policy, and user agreement. Transparent policies for our privacy-focused email forwarding service.`,
      'img/articles/terms.webp'
    ],
    '/gdpr': [
      `GDPR Compliance - EU Data Protection & Privacy Standards`,
      `Serverlets AI is fully GDPR compliant. Learn about our data protection practices, user rights, data processing, EU privacy law compliance, and how we safeguard your information.`,
    ...
    '/dpa': [
      ...
      `Download Serverlets AI's Data Processing Agreement for GDPR compliance. Standard contractual clauses, data protection terms, and processor obligations.`,
    ...
    '/privacy': [
      ...
      `Read Serverlets AI's privacy policy. We collect minimal data, never sell your information, and provide complete transparency about data handling practices and user rights.`,
      'img/articles/privacy.webp'
    ],
    '/help': [
      `Help & Support - Get Answers Fast ${currentYear}`,
      `Get help with Serverlets AI. Search our knowledge base, contact support, or join our community. Average response time under 4 hours. Find answers to all your email questions.`,
      'img/articles/help.webp'
    ],
    '/denylist': [
      `Denylist Removal - Unblock Your Email, Domain, or IP Address`,
      `Request removal from Serverlets AI's denylist. Submit your email address, domain, or IP for review. Most requests processed within 24 hours.`
    ],
    '/logout': [
      `Sign Out - Serverlets AI`,
      `Securely sign out of your Serverlets AI account. Your session will be terminated on all devices for maximum security. Return anytime to manage your email forwarding.`
    ],
    '/register': [
    ...
    '/self-hosted': [
      ...
      `Deploy your own email server with Serverlets AI's open-source code. Docker, Kubernetes, and bare-metal installation guides. Full control over your email infrastructure.`
    ],
    '/resources': [
    ...
    '/blog/docs': [
      ...
      `Complete developer documentation for Serverlets AI. RESTful API reference, code examples, SDKs, webhooks, and integration guides for all major languages.`
    ],
    '/guides': [
    ...
    '/guides/newsletter-with-listmonk': [
      `Listmonk Newsletter Setup with Serverlets AI SMTP ${currentYear}`,
      `Create and manage newsletters using Listmonk with Serverlets AI as your SMTP provider. Self-hosted newsletter solution with reliable email delivery and high deliverability.`
    ],
    '/guides/selfhosted-on-debian': [
      `Self-Hosted Serverlets AI on Debian - Installation Guide ${currentYear}`,
      `Complete guide to self-hosting Serverlets AI on Debian Linux. Docker and bare-metal installation, configuration, and maintenance instructions. Full control over your email.`
    ],
    '/guides/selfhosted-on-ubuntu': [
      `Self-Hosted Serverlets AI on Ubuntu - Installation Guide ${currentYear}`,
      `Complete guide to self-hosting Serverlets AI on Ubuntu Linux. Docker and bare-metal installation, configuration, and maintenance instructions. Full control over your email.`
    ],
    ...
    '/guides/smtp-integration': [
      ...
      `SMTP integration examples for Node.js, Python, PHP, Ruby, Go, Java, and more. Copy-paste code samples for reliable email sending with Serverlets AI. Production-ready code.`
    ],
    ...
    '/my-account': [
      ...
      `Manage your Serverlets AI account, domains, aliases, and settings. View analytics, update billing, configure security options, and control all your email forwarding.`
    ],
    ...
    '/my-account/profile': [
      ...
      `Update your Serverlets AI profile. Change email, password, notification preferences, and account settings. Customize your experience and manage your personal information.`
    ],
    '/my-account/billing': [
      `Billing & Subscription - Manage Your Plan`,
      `Manage your Serverlets AI subscription. View invoices, update payment methods, change your plan, and access your complete billing history. Flexible payment options available.`
    ],
    '/my-account/security': [
    ...
    '/admin': [
      `Admin Dashboard - Serverlets AI`,
      `Access your Serverlets AI admin dashboard for advanced management and configuration. Monitor system health, manage users, and control all administrative settings.`
    ],
    '/forgot-password': [
      `Reset Password - Recover Your Serverlets AI Account`,
      `Reset your Serverlets AI password. Enter your email to receive a secure password reset link. Regain access to your account quickly and safely with our recovery process.`
    ],
    '/ips': [
      `IP Addresses - Serverlets AI Server Infrastructure`,
      `Complete list of Serverlets AI IP addresses for SPF records and firewall whitelisting. Automatically updated and always current. Essential for DNS configuration.`
    ],
    '/reset-password': [
      `Confirm Password Reset - Serverlets AI`,
      `Confirm your password reset and create a new secure password for your Serverlets AI account. Choose a strong password to keep your email forwarding secure.`
    ],
    '/auth': [
      `Authenticate - Serverlets AI Login`,
      `Complete authentication to access your Serverlets AI account. Secure login process with multiple authentication options including passkeys, OAuth, and two-factor verification.`
    ],
    '/ubuntu': [
  ...
  meta[config.loginRoute] = [
    `Log In to Serverlets AI - Access Your Account`,
    `Sign in to your Serverlets AI account. Manage domains, aliases, and email forwarding settings. Secure login with passkeys, OAuth, and two-factor authentication.`
  ];
  meta[config.verifyRoute] = [
    `Verify Email Address - Confirm Your Serverlets AI Account`,
    `Verify your email address to activate your Serverlets AI account and start using email forwarding. Complete verification to unlock all features and start forwarding.`
  ];
