...
module.exports = {
  ...
  INVALID_SPF_RESULT:
    'Invalid SPF result (must start with <span class="notranslate">"v=spf1"</span> and include <span class="notranslate">"include:spf.serverlets.ai"</span>).',
  ...
  OAUTH_PROVIDER_DISCONNECTED_SUBJECT:
    '%s account disconnected from your Serverlets AI account',
  OAUTH_PROVIDER_DISCONNECTED_MESSAGE:
    'Your %s account has been disconnected from your Serverlets AI account. If you did not make this change, please contact us immediately.',
  ...
  SUPPORT_REQUEST_ERROR:
    'We were unable to send your help request.  We have been alerted of this problem.  Please try again or directly email <a href="mailto:support@serverlets.ai">support@serverlets.ai</a>.',
  ...
  IMPORT_ALIAS_DISABLED_NOBODY:
    'We successfully imported the disabled address of "<span class="notranslate">%s</span>", but we had to do so with a single recipient of "nobody@serverlets.ai" because it did not have a recipient in the imported DNS entry.',
  ...
  EMAIL_PAST_DUE:
    'Your account registered under <span class="notranslate">%s</span> is past due on payment. We have paused email forwarding and may suspend your account if this is not resolved.  Please visit <a href="https://serverlets.ai/my-account/billing">https://serverlets.ai/my-account/billing</a> to make payment.',
  MALICIOUS_DOMAIN_PLAN_UPGRADE_REQUIRED:
    'Domain name <span class="notranslate">%s</span> has a domain name extension that is frequently used for spam operations. Please <a class="font-weight-bold" href="%s">upgrade your domain</a> to continue. Please see our FAQ for the complete list of <a href="https://serverlets.ai/faq#what-domain-name-extensions-can-be-used-for-free" target="_blank">domain name extensions that can be used for free</a>.',
  MALICIOUS_DOMAIN:
    'Domain name <span class="notranslate">%s</span> has a domain name extension that is frequently abused for spam operations.  We require that users with this domain name extension upgrade to a paid plan in order to use our service.  Please see our FAQ for the complete list of <a href="https://serverlets.ai/faq#what-domain-name-extensions-can-be-used-for-free" target="_blank">domain name extensions that can be used for free</a>.',
  UPGRADE: 'Upgrade',
  BILLING: 'Billing',
  ...
  WEBSITE_OUTAGE:
    'We are resolving an issue with our website &ndash; visit our <a href="https://status.serverlets.ai" class="text-themed font-weight-bold" target="_blank" rel="noopener noreferrer">Status Page</a> for updates.',
  ...
  DOMAIN_CONNECT_TEMPLATE_NOT_FOUND:
    'Your DNS provider does not support the Serverlets AI Domain Connect template for %s. Please configure your DNS records manually.',
