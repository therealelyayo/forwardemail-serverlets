...
// 4 - host
// 5 - video
// 6 - trailing period (e.g. Gandi) <https://github.com/forwardemail/serverlets.ai/issues/197>
//
const NS_PROVIDERS = {
  awsdns: [
    'amazon-route-53',
...
const emailClients = _.sortBy(
  [
    ...
    },
    {
      ...
      attribution: 'Screenshot by Serverlets AI',
...
const useCases = {
  ...
  '/custom-domain-email-hosting': [
    'Custom Domain Email Hosting',
    "Set up custom domain email hosting in seconds with Serverlets AI. Get access to email hosting, forwarding, API's, IMAP, POP3, mailboxes, calendars, and more."
  ],
...
const descTemplates = [
  ...
  (desc, noun) =>
    `Serverlets AI offers ${desc} designed for ${noun.toLowerCase()}. Privacy-focused with quantum-resistant encryption, unlimited aliases, and full email hosting from $3/mo.`,
  (desc, noun) =>
...
useCases['/claude-email-tool'] = [
  'Claude Email Tool',
  'Connect Serverlets AI to Claude as a tool to manage your email with natural language.'
];
